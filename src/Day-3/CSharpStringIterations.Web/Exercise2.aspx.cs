...
namespace CSharpTypes.Web
{
    public partial class Exercise2 : System.Web.UI.Page
    {
        ...
        protected void btnGBP_Click(object sender, EventArgs e)
        {
            decimal gbpValue = Decimal.Parse(this.TextBox1.Text);
            MoneyForExercise2 gbp = new MoneyForExercise2(gbpValue, Currency.GBP);
            //
            this.lblFormattedMoney.Text = gbp.ToString();
        }
    }
}